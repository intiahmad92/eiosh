                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <article class="entry entry-box entry-box-blockquote bg-lightergray wow fadeInUp" style="width:270px; height:358px; float:left; margin-right:15px; margin-top:3px;">
                                                        <div class="entry-content" style="padding:20px;">
                                                            <blockquote>
                                                                <p>
                                                                    <a href="{{route('case-studies.detail',$service->slug)}}" class="pageLnks">{{$service->title}}</a>
                                                                </p>
                                                            </blockquote>
                                                        </div>
                                                        <div class="entry-media" style="margin-left:20px; width:227px !important; height:127px !important;">
                                                            ...
                                                            <figure class="about-widget-box">
                                                                <a href="{{route('case-studies.detail',$service->slug)}}" title="{{$service->title}}"><img alt="{{$service->title}}" src="{{asset('images/'.$service->image)}}" style="width:225px; height:125px; border:0px; padding:4px; vertical-align:middle;"></a>
                                                            </figure>
