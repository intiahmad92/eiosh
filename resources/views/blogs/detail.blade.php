                    ...
                    <div class="wow fadeInUp"> <!-- service  -->
                        ...
                        <div id="tabcontainer">
                            ...
                            <ul id="myTabs" class="nav nav-tabs no-padding" role="tablist">
                                <li role="presentation" class="active"><a href="#channelvideos" id="channelvideos-tab" aria-controls="channelvideos" role="tab" data-toggle="tab">{{$blog->title}}</a></li>
                            </ul>
                                    ...
                                    <div class="form-inline form-group">
                                        <div class="input-group">
                                            ...
                                            <div class="et_pb_section et_pb_section_0 et_section_regular">
                                                ...
                                                <div class="et_pb_text_inner">{!!$blog->description!!}</div>
                                              </div>
                                              </div>
